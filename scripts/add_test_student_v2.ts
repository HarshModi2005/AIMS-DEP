...
async function main() {
    // Test Student 2 Credentials
    const email = "test.student2@iitrpr.ac.in";
    const rollNumber = "2024CSB9998";
    const password = "password";

    console.log(`Creating test student 2: ${email}...`);
        ...
        await prisma.$transaction(async (tx) => {
            ...
            const user = await tx.user.upsert({
                ...
                create: {
                    ...
                    role: "STUDENT",
                    password: hashedPassword,
                    profilePhoto: "https://api.dicebear.com/7.x/avataaars/svg?seed=Test2"
                }
            });
