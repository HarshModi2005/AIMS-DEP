...
CREATE TABLE "SimpleFeedback" (
    ...
    CONSTRAINT "SimpleFeedback_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "OfferingInstructor_offeringId_idx" ON "OfferingInstructor"("offeringId");

-- CreateIndex
CREATE INDEX "OfferingInstructor_facultyId_idx" ON "OfferingInstructor"("facultyId");
...
-- CreateIndex
CREATE INDEX "FeedbackCycle_sessionId_idx" ON "FeedbackCycle"("sessionId");

-- CreateIndex
CREATE INDEX "CourseFeedback_cycleId_idx" ON "CourseFeedback"("cycleId");

-- CreateIndex
CREATE INDEX "CourseFeedback_studentId_idx" ON "CourseFeedback"("studentId");
...
-- CreateIndex
CREATE INDEX "SimpleFeedback_courseOfferingId_idx" ON "SimpleFeedback"("courseOfferingId");

-- CreateIndex
CREATE INDEX "SimpleFeedback_studentId_idx" ON "SimpleFeedback"("studentId");

-- CreateIndex
CREATE UNIQUE INDEX "SimpleFeedback_courseOfferingId_studentId_key" ON "SimpleFeedback"("courseOfferingId", "studentId");

-- CreateIndex
CREATE INDEX "AcademicDate_sessionId_idx" ON "AcademicDate"("sessionId");
...
-- AddForeignKey
ALTER TABLE "SimpleFeedback" ADD CONSTRAINT "SimpleFeedback_courseOfferingId_fkey" FOREIGN KEY ("courseOfferingId") REFERENCES "CourseOffering"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SimpleFeedback" ADD CONSTRAINT "SimpleFeedback_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_courseOfferingId_fkey" FOREIGN KEY ("courseOfferingId") REFERENCES "CourseOffering"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
