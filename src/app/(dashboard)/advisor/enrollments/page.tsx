        ...
        <div className="min-h-screen bg-zinc-950 text-white p-6">
            <div className="max-w-7xl mx-auto">
                <header className="mb-8">
                    ...
                    <p className="text-zinc-400">Select a batch to manage pending enrollment requests</p>
                </header>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {batches.map((batch) => (
                        <div key={`${batch.department}-${batch.batchYear}`} className="rounded-xl border border-white/10 bg-zinc-900/50 p-6 flex flex-col hover:border-indigo-500/50 transition-colors group">
                            ...
                            <div className="mt-6">
                                <Link
                                    ...
                                    className="w-full flex items-center justify-center px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 transition-colors text-sm font-medium"
                                >
                                    View Requests
                                </Link>
                            </div>
